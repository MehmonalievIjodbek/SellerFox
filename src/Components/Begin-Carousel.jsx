  ...
  const beginCard = [
    {
      ...
      desc: "Что такое аналитика данных маркетплейсов, зачем продавцу собирает информацию о чужих продажах и выручке. Вы узнаете какие данные о товарах и конкурентах можно собрать с помощью сервиса SellerFox и поймете как использовать их для планирования ваших закупок, отгрузок и продаж.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: "Урок 3. Пресеты сервиса аналитики Sellerfox",
